"""Runtime switches that control how much GLACIS derives on its own.

GLACIS is a *passive* notebook. Some convenience helpers would make it do more
...
Enable them explicitly with::
    ...
    export GLACIS_DERIVE_GUIDANCE=1      # shell / shell profile
    GLACIS_DERIVE_GUIDANCE=1 glacis      # single run
...
ENV_VAR = "GLACIS_DERIVE_GUIDANCE"
LEGACY_ENV_VAR = "CYB0X_DERIVE_GUIDANCE"
...
def _from_env() -> bool:
    raw = os.environ.get(ENV_VAR, "") or os.environ.get(LEGACY_ENV_VAR, "")
